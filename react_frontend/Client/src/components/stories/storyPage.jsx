...
const StoryPage = () => {
  ...
  <div className={`storyPart ${overlay} max-w-full sm:max-w-[600px] md:max-w-[800px] lg:max-w-[1000px] mx-auto py-8 px-4 sm:px-6 lg:px-8 relative`}>
    {auth.isLoggedIn ? (
      <>
        <div className="addstoryPart mb-12 bg-zinc-800 rounded-lg shadow-xl p-6">
          <h4 className={`text-2xl sm:text-3xl text-white font-bold mb-4 ${textSecondary}`}>Add Your Story</h4>
          <textarea
      ...
      <div className="mt-8 text-center">
        <h4 className={`text-xl sm:text-2xl font-bold mb-4 ${textSecondary}`}>Sign in to Add Your Story</h4>
